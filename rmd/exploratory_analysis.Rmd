...
Zooming in the cluster didn't yield anything interesting. There is a slight linear trend
...
reviews with lower counts and with an average rating greater than 3.3, a slight negative linear
...
titles <- filter(books, !is.na(original_title)) %>% unique()
...
wordcloud(words=d$word, freq=d$freq,
          max.words = 70, min.freq = 3, random.order = FALSE, colors=brewer.pal(8, "Dark2"))
```
